...
<head>
    ...
    <title>Dashboard | Online Death Registration</title>
                                    ...
                                    <div class="income-dashone-pro">
                                        <div class="income-rate-total">
                                            <div class="price-adminpro-rate">
                                                <h3><span
                                                        class="counter"><?php echo htmlentities($totalnewapp); ?></span>
                                                </h3>
                                            </div>
                                        ...
                                        <div class="income-range">
                                            ...
                                            <a class="block text-center" href="new-death-application.php"><strong
                                                    style="color:white">View Detail</strong></a>
                                        </div>
                                        <div class="clear"></div>
                                    </div>
                                </div>
                                ...
                                <div class="income-dashone-total orders-monthly shadow-reset nt-mg-b-30">
                                    ...
                                    <div class="income-dashone-pro">
                                        <div class="income-rate-total">
                                            <div class="price-adminpro-rate">
                                                <h3><span
                                                        class="counter"><?php echo htmlentities($totalverapp); ?></span>
                                                </h3>
                                            </div>
                                            <div class="price-graph">
                                        ...
                                        <div class="income-range order-cl">
                                            <a class="block text-center" href="verified-death-application.php"><strong
                                                    style="color:white">View Detail</strong></a>
                                        </div>
                                        <div class="clear"></div>
                                    </div>
                                ...
                                <div class="income-dashone-total visitor-monthly shadow-reset nt-mg-b-30">
                                    ...
                                    <div class="income-dashone-pro">
                                        <div class="income-rate-total">
                                            <div class="price-adminpro-rate">
                                                <h3><span
                                                        class="counter"><?php echo htmlentities($totalrejapp); ?></span>
                                                </h3>
                                            </div>
                                            <div class="price-graph">
